...
public class RedSampleAutoWithTurning extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-39.5, -65, Math.toRadians(0));
        ...
        Actions.runBlocking(new SequentialAction(
                new ParallelAction(
                        scorePreload.build(),
                        new setOuttakeSlides(outtakeSlideMotor_left, outtakeSlideMotor_right, -790, 1.0),
        ...
        Actions.runBlocking(new SequentialAction(
                new ParallelAction(
                        scoreSample1.build(),
                        new setOuttakeSlides(outtakeSlideMotor_left, outtakeSlideMotor_right, -825, 1.0),
                        new sampleScore(outtakePivotLeft, outtakePivotRight, outtakeTurret, outtakeWrist),
        ...
        TrajectoryActionBuilder collectSample2 = drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(new Vector2d(-58.2, -50), Math.toRadians(90));
        ...
        TrajectoryActionBuilder collectSample3 = drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(new Vector2d(-63, -50), Math.toRadians(94.2));

        Actions.runBlocking(new SequentialAction(
                new ParallelAction(
                        collectSample3.build(),
                        new outtakeTransfer(outtakePivotLeft, outtakePivotRight, outtakeTurret, outtakeWrist, outtakeClaw),
                        new setIntakeSlides(intakeMotor, 670, 1.0),
